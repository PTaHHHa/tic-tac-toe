            ...
            if player2_card.value < player1_card.value:
                ...
                while war:
                    ...
                    if len(player1.all_cards) < 2:
                        print(f'{player1.name} has not enough cards. ({len(player1.all_cards)}) {player2.name} won!')
                        war = False
                        game_on = False
                        break
                    elif len(player2.all_cards) < 2:
                        print(f'{player2.name} has not enough cards. ({len(player2.all_cards)}) {player1.name} won!')
                        war = False
                        game_on = False
                        break
                    for num in range(2):
                    ...
                    print(f'WAR! Player 1 cards: {[player.value for player in player1_war_cards]}')
                    print(f'WAR! Player 2 cards: {[player.value for player in player2_war_cards]}')
